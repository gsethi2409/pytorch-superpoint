...
class DSuperPointNet_gauss2(torch.nn.Module):
    ...
    def __init__(self, subpixel_channel=1):
        super(DSuperPointNet_gauss2, self).__init__()
        ...
        # Detector Head.
        self.convPa = DeformableConv2d(c4, c5, kernel_size=3, stride=1, padding=1)
        self.bnPa = nn.BatchNorm2d(c5)
        self.convPb = DeformableConv2d(c5, det_h, kernel_size=1, stride=1, padding=0)
